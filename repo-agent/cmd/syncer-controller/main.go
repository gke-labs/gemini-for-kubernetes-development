...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "syncer.gemini.google.com",
	})
	if err != nil {
	...
	if err != nil {
		...
		// For local development without GCP creds, maybe we want to mock or fail?
		// The controller will crash if we exit here.
		// We'll exit as this is a core requirement.
		os.Exit(1)
	}
