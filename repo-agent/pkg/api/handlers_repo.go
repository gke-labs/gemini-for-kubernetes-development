  ...
  issue:
    ...
    - llm:
        ...
        prompt: >-
          ...
          IMPORTANT: Your only task is to categorize the issue. Do NOT attempt
          to fix the issue, write code, or provide solutions. Do NOT verify the
          issue.
          ...
          3. cleanup: Suggestions for cleaning up code, removing deprecated
          features, or improving code quality.
          4. document: Issues related to documentation errors, omissions, or
          requests for clarification.
          5. support: Questions or requests for help regarding the use of the
          software.
          6. other: Any issue that does not fit into the above categories.
