...
func (s *Server) RegisterRoutes(router *gin.Engine) {
	...
	api.Use(s.Auth.Middleware())
	{
		...
		api.GET("/repo/:repo/prs/:id/tasks/:taskID/telemetry", s.getTaskTelemetry)
		...
		api.GET("/repo/:repo/dev/:name/tasks/:taskID/telemetry", s.getDevTaskTelemetry)
		api.GET("/repo/:repo/chores/:name/tasks/:taskID/logs", s.getChoreTaskLogs)
		api.GET("/repo/:repo/chores/:name/tasks/:taskID/telemetry", s.getChoreTaskTelemetry)
