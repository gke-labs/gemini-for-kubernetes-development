...
export BRANCH_NAME={{ printf "%q" .Branch }}
export REMOTE_NAME={{ printf "%q" .Remote }}
...
function runRollback {
    echo "Running runRollback to commit: ${COMMIT_SHA}"
    cd "/workspaces/${REPO_NAME}"
    ...
    echo "Rolling back branch ${BRANCH} on remote ${REMOTE} to commit ${COMMIT_SHA}..."
