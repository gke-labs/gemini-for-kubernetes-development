...
Only output the commit message itself.")
        ...
        PR_BODY="This Pull Request was automatically generated by the **${CHORE_NAME}** chore.

**Chore Definition:** [${CHORE_FILE}](https://github.com/${REPO_PATH}/blob/${BASE_BRANCH}/${CHORE_FILE})
