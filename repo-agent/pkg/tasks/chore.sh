...
#!/bin/bash
HTTPS_PROXY=http://github-portal.overseer-system.svc.cluster.local:80 SSL_CERT_FILE=/etc/github-portal/ca/tls.crt GIT_SSL_CAINFO=/etc/github-portal/ca/tls.crt /usr/bin/gh "$@"
EOF
