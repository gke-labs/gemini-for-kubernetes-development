...
func TestParseIssueURL(t *testing.T) {
	tests := []struct {
		...
		{"ssh://git@github.com/owner/repo/issues/123", "owner", "repo", 123, false},
		{"ssh://git@github.com:22/owner/repo/pull/456", "owner", "repo", 456, false},
		{"https://github.com:443/owner/repo/issues/123", "owner", "repo", 123, false},
