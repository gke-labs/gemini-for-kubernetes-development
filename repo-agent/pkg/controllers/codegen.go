...
//go:generate go tool sigs.k8s.io/controller-tools/cmd/controller-gen paths=./repoboard/... paths=./run/... output:rbac:dir=../../k8s rbac:roleName=repo-agent-controller,fileName=rbac.generated.yaml
