...
//go:generate go tool sigs.k8s.io/controller-tools/cmd/controller-gen paths=./controllers/... output:rbac:dir=../k8s rbac:roleName=syncer-role,fileName=syncer-rbac.generated.yaml
